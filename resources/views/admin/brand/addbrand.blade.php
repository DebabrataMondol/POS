...
<button style="margin-left: 85%;margin-bottom: 11px;" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Add New Brand</button>
                  ...
                  <tr>
                     ...
                     <td>
                      ...
                      @endif
             			...
             			<a id="delete-button" href="{{route('deletebrand',['id'=>$brand->id])}}" class="btn btn-danger btn-xs">
