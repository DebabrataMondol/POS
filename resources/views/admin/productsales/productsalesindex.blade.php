...
@section('content')
    ...
    <div class="container">
        <form action="{{route('addSaleInvoice')}}" method="post">
            <div style="border: 1px solid lightgrey;" class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Customer Name:</label>
                        <div class="input-group">
                            <select class="form-control" name="saleInvoice_customerName" id="customerName" required>
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control" name="saleInvoice_previousDue" id="previousdue" readonly/>
                        </div>
                    </div>
                </div>
                <div class="col-sm-2">
            ...
            <div class="row">
                <div style="border: 1px solid lightgrey; padding-top: 5px;" class="col-md-8">
                    <div style="margin-top: 0px; padding-top: 0px;" class="row">
                        <div style="padding-top: 0px;" class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control addTocart " name="saleInvoice_description"
                        ...
                        @if(Session::has('carts'))
                            ...
                            @foreach($products as $product)
                                <tr style="text-align: center;">
                                    <th>{{ ++$i }}</th>
                                    <td style="width: 220px;" class="saleItemDescription">{{ $product['item']->report_description }}</td>
                                    <td>{{ $product['item']->report_quantity }}</td>
                                    <td style="width: 55px;" class="saleItemQuantity">{{$product['qty']}}</td>
                ...
                <div style="border: 1px solid lightgrey; padding-top: 5px;" class="col-md-4">
                    <div class="form-group  row">
                        <label for="SubTotal" class="col-sm-6  text col-form-label">SubTotal</label>
                        <div class="col-sm-6">
                            <input type="text" name="saleInvoice_subTotal" readonly class="form-control SubTotal "
                                   value="{{$totalPrice}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="saleInvoice_discountType" class="form-control discType">
                                <option id="t" value="t">TK</option>
                                <option id="p" value="p">%</option>
                            </select>
                            <input style="margin-left: 0px;" type="text" name="saleInvoice_discountAmount" value=""
                    ...
                    <div class="form-group row">
                        ...
                        <label for="TotalPayable"
                            ...
                            %)</label>
                        <div class="col-sm-6">
                            <input type="text" name="saleInvoice_vatAmount" readonly class="form-control vats"/>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row ">
                        <label for="PaidAmount" class="col-sm-6 text control-label col-form-label">Paid
                            Amount</label>
                        <div class="col-sm-6">
                            <input type="text" name="saleInvoice_paidAmount" class="form-control pAmount" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="ReturnAmount" class="col-sm-6 text col-form-label pull-right">Return
                            Amount</label>
                        <div class="col-sm-6">
                            <input type="text" name="saleInvoice_returnAmount" readonly class="form-control ramount">
                        </div>
                    </div>
                    <div class="form-group  row">
                        <label for="DueAmount" class="col-sm-6 text  col-form-label">Due Amount</label>
                        <div class="col-sm-6">
                            <input type="text" name="saleInvoice_dueAmount" readonly class="form-control damount">
                            <input type="hidden" name="saleInvoice_transactionStatus" readonly class="form-control status">
                        </div>
                    </div>


                    <div class="form-group  row">
                        <label for="DueAmount" class="col-sm-6 text  col-form-label">Collection type:</label>
                        <div class="col-sm-6">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', 'li', function () {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {description: description,invoiceNo:invoiceNo},
                    success: function () {
                        location.reload();
                    }
                });
