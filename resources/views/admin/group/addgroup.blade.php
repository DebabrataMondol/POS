...
<button style="margin-left: 85%;margin-bottom: 11px;" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Add New Group</button>
    ...
    <div class="modal-content">
      <div class="card">
        <div class="card-header">
          ...
          <form  id="add_teachers" method="post" action="{{route('groupadd')}}" enctype="multipart/form-data">
                @csrf
         <div class="modal-body">
			...
			<div class="col-sm-12">
			     <div class="form-group">
			      ...
			      <input type="text" class="form-control" id="name" name="group_name" placeholder="Group Name">
			    </div>
			  </div>
                  ...
                  <tr>
                     ...
                     <td>
                      ...
                      @endif
             			...
             			<a id="delete-button" href="{{route('deletegroup',['id'=>$allgroup->id])}}" class="btn btn-danger btn-xs">
