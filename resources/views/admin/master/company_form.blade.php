<div class="row">
    ...
    <div class="col-sm-4 form-group">
        ...
        <input class="form-control" type="text" name="company_mobile" placeholder="Company Mobile">
    </div>
    <div class="col-sm-4 form-group">
    ...
    <div class="col-sm-4 form-group">
     ...
     <div class="col-sm-4 form-group">
        ...
        <input class="form-control" type="text" name="company_address" placeholder="Company Address">
    </div>
    ...
    <option value="BD" SELECTED="YES">Bangladesh</option>
    ...
    <div class="col-sm-4 form-group">
        ...
        <input class="form-control" type="text" name="company_vat" placeholder="Company Vat">
    </div>
