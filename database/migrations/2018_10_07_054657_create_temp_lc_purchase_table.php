...
class CreateTempLcPurchaseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_lc_purchase', function (Blueprint $table) {
            $table->increments('temp_lcpur_id');
    ...
    {
        Schema::dropIfExists('temp_lc_purchase');
    }
}
